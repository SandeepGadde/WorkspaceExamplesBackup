...
public class NotesInterpreter {
	...
	/**
	 * This method gets the note from the keys pressed. Them, this sets it at a
	 * global level.
	 */
	...
	/**
	 * This method gets the frequency for the note. Say, if the note is “Sa”, it
	 * will return 256.
	 */
	private Frequency getFrequency(Note note) {
		...
		// and return it.
		return new Frequency(note.getFreq());
	}

	/**
	 * This method forwards the frequency to the sound producer which is some
	 * electronic instrument which plays the sound.
	 */
